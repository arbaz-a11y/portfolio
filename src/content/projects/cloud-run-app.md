---
title: "Deploying a Flask App on GCP Cloud Run"
group: "cloud"
...
My GCP Associate Cloud Engineer practice project — deploying the same small app up the ladder: console first, then `gcloud`, then Terraform. Keeping notes in my blog as I go.
